...
const PROFILE_SUITABILITY: Record<RegionProfile, LocalitySuitability> = {
    commercial: {
        casual_meetup_score: 0.85,
        lesson_spot_score: 0.55,
        solo_activity_score: 0.5,
        group_activity_score: 0.78,
        night_liveliness_score: 0.9,
    },
    residential: {
        casual_meetup_score: 0.5,
        lesson_spot_score: 0.45,
        solo_activity_score: 0.45,
        group_activity_score: 0.4,
        night_liveliness_score: 0.3,
    },
    park: {
        casual_meetup_score: 0.7,
        lesson_spot_score: 0.6,
        solo_activity_score: 0.75,
        group_activity_score: 0.65,
        night_liveliness_score: 0.3,
    },
    campus: {
        casual_meetup_score: 0.78,
        lesson_spot_score: 0.85,
        solo_activity_score: 0.65,
        group_activity_score: 0.8,
        night_liveliness_score: 0.65,
    },
    mixed: {
        casual_meetup_score: 0.6,
        lesson_spot_score: 0.55,
        solo_activity_score: 0.55,
        group_activity_score: 0.55,
        night_liveliness_score: 0.5,
    },
};
...
function applySuitabilityJitter(
    base: LocalitySuitability,
): LocalitySuitability {
...
function build(): LocalityFeatureSet {
    ...
    for (const seed of SUWON_REGIONS) {
        ...
        const suitability = applySuitabilityJitter(
            PROFILE_SUITABILITY[seed.profile],
        );
        ...
        regions.push({
            ...
            raw_place_count: Math.round(
                Object.values(density).reduce((s, v) => s + v, 0) *
                    seed.area_km2,
            ),
