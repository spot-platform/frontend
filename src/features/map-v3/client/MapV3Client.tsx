// map-v3 병행 라우트 전용 client. 승격 시 src/features/map/client/MapClient.tsx 로 리네이밍 예정.
'use client';
...
import { useActivityClusters } from '@/features/map-v3/model/use-activity-clusters';
import { ClusterMarker } from '@/features/map-v3/ui/ClusterMarker';
import { PersonaDotMarker } from '@/features/map-v3/ui/PersonaDotMarker';
import { ClusterBottomSheetHeader } from '@/features/map-v3/ui/ClusterBottomSheetHeader';
import { LiveTicker } from '@/features/map-v3/ui/LiveTicker';
import { ThemeSegment } from '@/features/map-v3/ui/ThemeSegment';
import {
    createTickerAdapter,
    type TickerEvent,
} from '@/features/map-v3/model/ticker-adapter';
...
const MapV3Canvas = dynamic(
    () => import('@/features/map-v3/ui/MapV3Canvas').then((m) => m.MapV3Canvas),
    { ssr: false },
);

export function MapV3Client() {
    ...
    // selectedSpotId 는 URL 상태 호환성만 유지. (Phase 8 에서 cluster 필드로 승격 예정)
    void selectedSpotId;
