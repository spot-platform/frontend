...
function toSupportProfileFormState(
    profile: NonNullable<
        NonNullable<ReturnType<typeof useSupporterProfile>['data']>['data']
    >,
): SupportProfileFormState {
    return {
        field: profile.field,
...
export function MySupportProfilePageClient() {
    ...
    const [formDraft, setFormDraft] = useState<SupportProfileFormState | null>(
        null,
    );
    ...
    const initialForm = useMemo(
        () => (profile ? toSupportProfileFormState(profile) : EMPTY_FORM),
        [profile],
    );
