...
function toSupportRegisterFormState(
    registration: NonNullable<
        NonNullable<ReturnType<typeof useSupporterRegistration>['data']>['data']
    >,
): SupportRegisterFormState {
    return {
...
export function MySupportRegisterPageClient() {
    ...
    const [formDraft, setFormDraft] = useState<SupportRegisterFormState | null>(
        null,
    );
    ...
    const initialForm = useMemo(
        () =>
            registration
                ? toSupportRegisterFormState(registration)
                : EMPTY_FORM,
        [registration],
    );
