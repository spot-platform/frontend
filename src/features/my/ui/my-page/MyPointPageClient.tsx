...
export function MyPointPageClient() {
    ...
    const [accountForm, setAccountForm] =
        useState<AccountFormState>(EMPTY_ACCOUNT_FORM);
    ...
    const [syncedLinkedAccount, setSyncedLinkedAccount] =
        useState(linkedAccount);

    if (linkedAccount && linkedAccount !== syncedLinkedAccount) {
        setSyncedLinkedAccount(linkedAccount);
        setAccountForm({
